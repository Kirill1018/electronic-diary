    ...
    internal interface IDataSourc
    {
        public static void Load(Diary diary)
        {
            string sql = "select * from passSubj where Id = (select Id from passSubj where "
                + $"groupId = ({SelGroupIdFromUs(diary.Identifier)}) and isArch = 'false')";
            ...
            foreach (Homework homework in works) SelFromLess(homework);
            foreach (string table in tables) foreach (Homework homework in works) SelFromSubj(table, homework);
            foreach (string table in tables) foreach (Homework homework in works) SelFromUs(homework.GetUserId(), homework);
            foreach (Homework homework in works)
            {
            ...
            foreach (Homework homework in worksNeedToBeSubm) SelFromLess(homework);
            foreach (string table in tables) foreach (Homework homework in worksNeedToBeSubm) SelFromSubj(table, homework);
            foreach (string table in tables) foreach (Homework homework in worksNeedToBeSubm) SelFromUs(homework.GetUserId(), homework);
        ...
        static string SelGroupIdFromUs(int? identifier) => $"select groupId from users where Id = {identifier}";
        static void Add(List<Subject> subjects, List<string> names,
        ...
        static void SelFromLess(Homework work)
        {
        ...
        static void SelFromSubj(string schedule, Homework work)
        {
        ...
        static void SelFromUs(int? identifier, Homework work)
        {
